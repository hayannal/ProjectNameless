...
public class PetShowCanvasBase : MonoBehaviour
{
	...
	protected void SetInfoCameraMode(bool enable, string actorId)
	{
		...
		if (enable)
		{
			...
			{
				_groundTransform = BattleInstanceManager.instance.GetCachedObject(ContentsPrefabGroup.instance.petInfoGroundPrefab, _rootOffsetPosition, Quaternion.identity).transform;
