...
public class GoldDefenseMissionGround : MonoBehaviour
{
	public static GoldDefenseMissionGround instance;
	...
	public void OnClickBox(int index)
	{
		...
		_waitSpawn = true;
		SpawnTeamMember(index, GoldDefenseMissionCanvas.instance.currentSelectedActorId);
		GoldDefenseMissionCanvas.instance.OnSpawnActor(index);
